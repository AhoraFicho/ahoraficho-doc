...
> **Afecta a**: TODAS las empresas en España, sin importar el tamaño
...
✅ **Registro diario**: Cada día laborable debe quedar registrado
✅ **Hora de inicio**: Momento exacto de entrada
✅ **Hora de finalización**: Momento exacto de salida
✅ **Por cada trabajador**: Todos los empleados, sin excepción
✅ **Conservación**: Mínimo 4 años
✅ **Disponibilidad**: Accesible para empleados, representantes e Inspección
...
1. **Identificación del trabajador**: Nombre y apellidos
2. **Fecha**: Día completo (DD/MM/AAAA)
3. **Hora de inicio**: Momento de entrada (HH:MM)
4. **Hora de finalización**: Momento de salida (HH:MM)
...
1. **Los propios trabajadores**: Derecho a consultar sus fichajes
2. **Representantes legales**: Delegados sindicales, comité de empresa
3. **Inspección de Trabajo**: Cuando lo requiera
...
✅ **Informar** a los trabajadores del tratamiento de datos
✅ **Limitar el acceso** solo a personas autorizadas
✅ **Garantizar seguridad** de los datos (cifrado, respaldos)
✅ **No usar** los datos para otros fines (solo control horario)
✅ **Eliminar** datos tras los 4 años obligatorios (o más según convenio)
...
✅ **Registro diario**: Cada fichaje queda registrado con fecha y hora exacta
✅ **Hora de inicio y fin**: Se registran ambas obligatoriamente
✅ **Identificación del trabajador**: Cada fichaje está asociado a un empleado único
✅ **Conservación 4 años**: Los datos se conservan automáticamente
✅ **Acceso garantizado**: Empleados, managers e inspectores pueden acceder
✅ **Trazabilidad**: Todas las modificaciones quedan registradas
✅ **Exportación**: Informes en PDF para Inspección de Trabajo
✅ **Protección de datos**: Cumplimiento RGPD con cifrado y accesos controlados
...
👉 [Ver: Informe para Inspección](/reportes/informe-inspeccion-trabajo/)
...
- **Real Decreto-ley 8/2019, de 8 de marzo**: [BOE-A-2019-3481](https://www.boe.es/eli/es/rdl/2019/03/08/8/con)
